...
do
    ...
    # search query
    res=$(gh pr list -s open --search " -author:@me -author:knative-automation involves:@me" --json author,title,author,createdAt,updatedAt,mergedAt,number,url,state,labels,files)
